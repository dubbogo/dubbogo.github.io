        ...
        <section className="introduction-section">
          <div className="introduction-body">
            <div className="introduction">
              <h3>{dataSource.introduction1.title}</h3>
              <p>{dataSource.introduction1.desc}</p>
            </div>
            <img src={`${window.rootPath}${dataSource.introduction1.img}`} />
          </div>
        </section>
        <section className="introduction-section">
          <div className="introduction-body">
            <div className="introduction">
              <h3>{dataSource.introduction2.title}</h3>
              <p>{dataSource.introduction2.desc}</p>
            </div>
            <img src={`${window.rootPath}${dataSource.introduction2.img}`} />
          </div>
        </section>
